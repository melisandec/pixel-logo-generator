...
> = {
  [BADGE_TYPES.FIRST_CAST]: {
    name: "First Forge",
    description: "Cast your first logo",
    icon: "🎯",
    rarity: "common",
  },
  [BADGE_TYPES.NOVICE_FORGER]: {
    name: "Novice Forger",
    description: "Cast 5 logos",
    icon: "🔨",
    rarity: "common",
  },
  [BADGE_TYPES.SKILLED_FORGER]: {
    name: "Skilled Forger",
    description: "Cast 25 logos",
    icon: "⚒️",
    rarity: "rare",
  },
  [BADGE_TYPES.MASTER_FORGER]: {
    name: "Master Forger",
    description: "Cast 100 logos",
    icon: "🏆",
    rarity: "epic",
  },
  [BADGE_TYPES.LEGENDARY_FORGER]: {
    name: "Legendary Forger",
    description: "Cast 500 logos",
    icon: "👑",
    rarity: "legendary",
  },

  [BADGE_TYPES.RARE_COLLECTOR]: {
    name: "Rare Collector",
    description: "Cast 10 RARE logos",
    icon: "🔵",
    rarity: "rare",
  },
  [BADGE_TYPES.EPIC_COLLECTOR]: {
    name: "Epic Collector",
    description: "Cast 5 EPIC logos",
    icon: "🟣",
    rarity: "epic",
  },
  [BADGE_TYPES.LEGENDARY_HUNTER]: {
    name: "Legendary Hunter",
    description: "Cast 1 LEGENDARY logo",
    icon: "🟠",
    rarity: "epic",
  },
  [BADGE_TYPES.LEGENDARY_MASTER]: {
    name: "Legendary Master",
    description: "Cast 10 LEGENDARY logos",
    icon: "⭐",
    rarity: "legendary",
  },

  [BADGE_TYPES.DAILY_CHAMPION]: {
    name: "Daily Champion",
  ...
  [BADGE_TYPES.STREAK_LEGEND]: {
    name: "Streak Legend",
    description: "30-day streak",
    icon: "🔥🔥🔥",
    rarity: "legendary",
  },
  [BADGE_TYPES.CHALLENGE_MASTER]: {
  ...
  [BADGE_TYPES.POPULAR]: {
    name: "Popular",
    description: "Get 10 likes on a cast",
    icon: "❤️",
    rarity: "common",
  },
  [BADGE_TYPES.VIRAL]: {
    name: "Viral",
    description: "Get 50 likes on a cast",
    icon: "💥",
    rarity: "epic",
  },
  [BADGE_TYPES.COMMUNITY_FAVORITE]: {
    name: "Community Favorite",
    description: "Get 100 likes on a cast",
    icon: "🌟",
    rarity: "legendary",
  },
  [BADGE_TYPES.RECAST_KING]: {
    name: "Recast King",
    description: "Get 10 recasts",
    icon: "🔁",
    rarity: "rare",
  },

  [BADGE_TYPES.DAILY_WINNER]: {
    name: "Daily Winner",
    description: "Win daily leaderboard",
    icon: "🏆",
    rarity: "epic",
  },
  [BADGE_TYPES.WEEKLY_CHAMPION]: {
...
export type ExtraBadgeType =
  (typeof EXTRA_BADGE_TYPES)[keyof typeof EXTRA_BADGE_TYPES];

export const EXTRA_BADGE_INFO: Record<
  ExtraBadgeType,
  {
    name: string;
    description: string;
...
> = {
  [EXTRA_BADGE_TYPES.RARITY_COMMON]: {
    ...
    description: "Collect at least one COMMON logo",
    icon: "✔️",
    rarity: "common",
  },
  [EXTRA_BADGE_TYPES.RARITY_RARE]: {
    name: "Rare Collector",
    description: "Collect at least one RARE logo",
    icon: "🔵",
    rarity: "rare",
  },
  [EXTRA_BADGE_TYPES.RARITY_EPIC]: {
    name: "Epic Collector",
    description: "Collect at least one EPIC logo",
    icon: "🟣",
    rarity: "epic",
  },
  [EXTRA_BADGE_TYPES.RARITY_LEGENDARY]: {
    name: "Legendary Collector",
    description: "Collect at least one LEGENDARY logo",
    icon: "🟠",
    rarity: "epic",
  },
  [EXTRA_BADGE_TYPES.RARITY_MASTER]: {
    name: "Rarity Master",
    description: "Collected one of each rarity",
    icon: "🎉",
    rarity: "legendary",
  },
};
